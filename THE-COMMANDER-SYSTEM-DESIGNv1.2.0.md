# **The-Commander: System Operating Architecture v1.2.0**

**Last Updated:** 2025-12-31  
**Version:** 1.2.0 (Authoritative Topology & Commander Protocol Layer)  
...
| **HTPC** | `10.0.0.42:8001` | Storage/Relay | Central Dataset authority and primary message relay node. |
| **Laptop Node** | `10.0.0.93:8002` | Worker | Model server and agent execution environment. |
| **Steam Deck Node** | `10.0.0.139:8003` | Worker | Model server and agent execution environment. |
...
The-Commander uses a persistent memory system backed by **SQLite** through the **SQLAlchemy ORM**.
