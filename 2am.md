...
| **node-steamdeck**| Steam Deck | Custom APU | **30** | Granite-4.0-h-tiny (65k ctx, 32 NGL) |
| **node-laptop**| Gillsystems-Laptop| Integrated | **9** | Granite-4.0-h-tiny (65k ctx, 999 NGL) |
